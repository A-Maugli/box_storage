...
from smart_contracts.artifacts.box_storage.game_client import GameClient


@pytest.fixture(scope="session")
def app_client(algod_client: AlgodClient, indexer_client: IndexerClient) -> GameClient:
    config.configure(
        debug=True,
        # trace_all=True,
    )
...
def test_register(algod_client: AlgodClient, app_client: GameClient) -> None:
...
def test_admin_upsert_asset(algod_client: AlgodClient, app_client: GameClient) -> None:
...
def test_buy_asset(algod_client: AlgodClient, app_client: GameClient) -> None:
...
from smart_contracts.box_storage.contract import BoxStorage
